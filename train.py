...
# torch.set_float32_matmul_precision("high")  # allows TF32 for fp32 matmuls
from torch.nn.parallel import DistributedDataParallel as DDP
from torch.distributed import init_process_group, destroy_process_group

from looped_gpt import GPTConfig, GPT


# -----------------------------------------------------------------------------
# default config values designed to train a gpt2 (335M) on OpenWebText
# I/O
out_dir = '~/checkpoints'
eval_interval = 1000
log_interval = 1
...
# --- NEW CONFIGURATIONS FOR PONDERING ---
recurrent_refinement = True  # Set to True to enable the loop mechanism
loop_steps = 4  # Number of refinement steps (K)
# -----------------------------------------------------------------------------
...
data_dir = os.path.join('/ssd1/ss95332/scratch/data', dataset)
...
model_args = dict(n_layer=n_layer, n_head=n_head, n_embd=n_embd, block_size=block_size,
                  ...
                  recurrent_refinement=recurrent_refinement,  loop_steps=loop_steps)
...
if init_from == 'scratch':
    ...
    ckpt_path = os.path.join(out_dir, 'ckpt_loop.pt')
...
while True:
    ...
    if iter_num % eval_interval == 0 and master_process:
        ...
        with open(f"logs/loop-gpt_k{loop_steps}.txt", "a") as log_file:
        ...
        if losses['val'] < best_val_loss or always_save_checkpoint:
            ...
            if iter_num > 0:
                ...
                torch.save(checkpoint, os.path.join(out_dir, 'ckpt_loop.pt'))
